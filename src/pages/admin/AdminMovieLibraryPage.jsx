...
export default function AdminMovieLibraryPage() {
  ...
  // Restore 100 Offline TMDB Movies
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-xs sm:text-sm text-neutral-500 font-semibold mt-2">
            Manage your platform&apos;s content catalog ({movies.length} Movies
            Active — Synced with User Website).
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {/* Restore 100 Offline Backup Button */}
          <button
            onClick={handleRestore100Movies}
          ...
          >
            ...
            <span className="hidden sm:inline">Load 100 Offline Backup</span>
          </button>
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-4">
                        <img
                          ...
                          alt={movie.title}
                          className="w-12 h-16 object-cover rounded-xl shadow-xs border border-neutral-200 shrink-0"
                          loading="lazy"
                        />
