...
import { HERO_PROMOTION, ACTIVE_PROMOTIONS } from '../../data/promotionData';
        ...
        {promo ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-start">
            ...
            <div
              ...
              style={{ background: 'linear-gradient(135deg, #B90101 0%, #6d0808 100%)' }}
            >
                ...
                <>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 text-white font-black italic leading-none text-center px-4">
                    {groupIntoLines(promo.offerTag).map((line) => (
                      <span key={line} className="text-4xl sm:text-5xl [text-shadow:_2px_2px_0_#FFD700]">
                        {line}
                      </span>
                    ))}
                  </div>
            ...
            <div className="pt-1 sm:pt-4 pr-8">
              ...
              <div className="mt-5 space-y-2.5">
                {promo.dateRange && (
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className={`text-[15px] ${isDark ? 'text-neutral-300' : 'text-neutral-700'}`}>
                      {promo.dateRange}
                    </span>
                  </div>
                )}
              ...
              <p className={`mt-5 text-[15px] leading-relaxed ${isDark ? 'text-neutral-300' : 'text-neutral-700'}`}>
                <strong className={isDark ? 'text-white' : 'text-neutral-900'}>{promo.title}</strong>
                {' — '}
                {promo.description}
              </p>
            </div>
          ...
          <div className="p-8 text-center">
            <p className={`text-[15px] ${isDark ? 'text-neutral-300' : 'text-neutral-700'}`}>
