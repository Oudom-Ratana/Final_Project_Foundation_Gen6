...
export default function StreamCard({ movie }) {
    ...
    // Handle genre resolution (same as MovieCard)
    ...
    return (
        <div className="group flex flex-col space-y-3 font-sans cursor-pointer">
            ...
            >
                ...
                {/* Top Row: Type of Movie (genre) pill on the left + Favourite Heart on the right in the same row */}
                <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                    {/* Red Genre Pill Badge (Type of Movie button) */}
                    <span
                    ...
                    <button
                        ...
                        className="shrink-0 hover:scale-110 active:scale-95 transition-all flex items-center justify-center"
                        aria-label={
                            isFavourite
                    ...
                    >
                        <Heart
                            className={`w-6 h-6 ${isFavourite
                                    ? "fill-[#B90101] text-[#B90101]"
                                    : "text-[#B90101] hover:text-[#B90101]"
                                }`}
                        />
                    </button>
                </div>
            ...
            {/* Rating Badge with the word "Rating" before the star icon */}
            <div className="pt-0.5">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[var(--primary-color-5)] backdrop-blur-md border border-[#FFD700]/60 shadow-md">
                    <span className="text-[14px] font-bold text-[#FFD700] leading-none">
                        Rating
                    </span>
                    <Star className="w-3.5 h-3.5 fill-[#FFD700] text-[#FFD700]" />
                    <span className="text-[14px] font-black text-[#FFD700] leading-none">{rating}</span>
                </span>
            </div>
        </div>
    );
