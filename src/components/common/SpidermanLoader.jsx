...
export default function SpidermanLoader({
  ...
  const sizeMap = {
    ...
    md: { container: "w-44 h-44", eye: "scale-100", text: "text-sm sm:text-base" },
    ...
    <div className="flex flex-col items-center justify-center gap-6 select-none font-sans">
      ...
      <div className={`relative ${currentSize.container} flex items-center justify-center`}>
        ...
        >
          ...
          <circle cx="100" cy="100" r="30" stroke="#B90101" strokeWidth="1" strokeDasharray="3 3" opacity="0.6" />
          <circle cx="100" cy="100" r="55" stroke="#B90101" strokeWidth="1.2" strokeDasharray="4 4" opacity="0.7" />
          <circle cx="100" cy="100" r="80" stroke="#B90101" strokeWidth="1.5" strokeDasharray="6 6" opacity="0.8" />
          <circle cx="100" cy="100" r="95" stroke="#00D2FF" strokeWidth="1" strokeDasharray="8 8" opacity="0.5" />

          {/* Web radial spokes */}
          <line x1="100" y1="5" x2="100" y2="195" stroke="#B90101" strokeWidth="1.2" opacity="0.5" />
          <line x1="5" y1="100" x2="195" y2="100" stroke="#B90101" strokeWidth="1.2" opacity="0.5" />
          <line x1="33" y1="33" x2="167" y2="167" stroke="#B90101" strokeWidth="1" opacity="0.4" />
          <line x1="33" y1="167" x2="167" y2="33" stroke="#B90101" strokeWidth="1" opacity="0.4" />
        </svg>
        ...
        <svg
          ...
          viewBox="0 0 160 160"
        >
          <circle cx="80" cy="10" r="3" fill="#CCFF00" className="animate-pulse" />
          <circle cx="150" cy="80" r="2.5" fill="#FFD700" />
          <circle cx="80" cy="150" r="3" fill="#CCFF00" className="animate-pulse" />
          <circle cx="10" cy="80" r="2.5" fill="#FFD700" />
        </svg>

        {/* 2. Spider-Man Mask with Expressive Blinking Eyes */}
        <div className={`relative z-10 w-28 h-32 flex items-center justify-center ${currentSize.eye}`}>
          <svg
            viewBox="0 0 120 140"
          ...
          >
            ...
            <path d="M60 5 L60 138" stroke="#1A0000" strokeWidth="1.2" opacity="0.7" />
            <path d="M10 75 Q60 65 110 75" stroke="#1A0000" strokeWidth="1.2" opacity="0.7" />
            <path d="M20 40 Q60 30 100 40" stroke="#1A0000" strokeWidth="1" opacity="0.6" />
            <path d="M18 105 Q60 115 102 105" stroke="#1A0000" strokeWidth="1" opacity="0.6" />
            <path d="M30 18 Q60 60 30 128" stroke="#1A0000" strokeWidth="0.9" opacity="0.5" />
            <path d="M90 18 Q60 60 90 128" stroke="#1A0000" strokeWidth="0.9" opacity="0.5" />
            ...
            <defs>
              ...
              <linearGradient id="lensWhiteGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <div className="flex flex-col items-center text-center gap-1.5">
        ...
        <div className="w-36 sm:w-48 h-1.5 bg-neutral-800 rounded-full overflow-hidden relative shadow-inner">
          <div className="h-full bg-gradient-to-r from-[#B90101] via-[#CCFF00] to-[#B90101] w-1/3 rounded-full animate-[shimmer_1.5s_infinite_linear]"
               style={{
