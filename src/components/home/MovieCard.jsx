  ...
  return (
    <div className="group flex flex-col space-y-3 font-sans cursor-pointer">
      ...
      <Link
        ...
        className="relative aspect-[291/386] w-full overflow-hidden shadow-md dark:shadow-2xl bg-neutral-900 border border-neutral-200/80 dark:border-white/10 group-hover:scale-[1.02] group-hover:shadow-2xl transition-all duration-300 rounded-tl-[25px] rounded-br-[25px] rounded-tr-none rounded-bl-none"
        style={{
