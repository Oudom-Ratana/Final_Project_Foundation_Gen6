  ...
  return [
    {
      ...
      scheduleByDate: {
        "2026-08-25": JSON.parse(JSON.stringify(baseSenSokHalls)),
        "2026-08-26": JSON.parse(JSON.stringify(baseSenSokHalls)),
        "2026-08-27": JSON.parse(JSON.stringify(baseSenSokHalls)),
      },
    },
    {
      id: "eden-garden",
